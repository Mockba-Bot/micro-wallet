...
import { UpdateWalletDto, CreateWalletDto } from './dto/wallet.dto';
...
export class WalletService {
  ...
  async create(userId: string, createWalletDto: CreateWalletDto): Promise<WalletEntity> {
    try {
      const walletDto = {
        ...createWalletDto,
        user: userId,
      };
      return await this.walletRepository.create(walletDto);
    } catch (error) {
